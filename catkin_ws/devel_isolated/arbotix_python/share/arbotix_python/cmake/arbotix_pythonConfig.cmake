...
if("TRUE" STREQUAL "TRUE")
  set(arbotix_python_SOURCE_PREFIX /home/dilucia/catkin_ws/src/rob_arm/arbotix/arbotix_python)
  set(arbotix_python_DEVEL_PREFIX /home/dilucia/catkin_ws/devel_isolated/arbotix_python)
  ...
  set(arbotix_python_INSTALL_PREFIX /home/dilucia/catkin_ws/install_isolated)
...
if(NOT " " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'arbotix_python' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/dilucia/catkin_ws/src/rob_arm/arbotix/arbotix_python/${idir}'.  Ask the maintainer 'Michael Ferguson <mike@vanadiumlabs.com>' to fix it.")
    endif()
